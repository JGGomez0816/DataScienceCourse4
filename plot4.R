...
with(power7,plot(dateTime,Global_active_power,type="l", col = "black", xlab=" ",
...
with(power7,plot(dateTime,Voltage,type="l", col = "black", xlab="datetime",
		ylab = "Voltage"))

with(power7,plot(dateTime,Global_reactive_power,type="l", 
